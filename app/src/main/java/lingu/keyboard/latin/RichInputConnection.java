...
import lingu.keyboard.latin.common.UnicodeSurrogate;
...
import lingu.keyboard.latin.utils.DebugLogUtils;
import lingu.keyboard.latin.utils.NgramContextUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See lingu.keyboard.latin.common.Constants.UnicodeSurrogate
