...
package lingu.keyboard.latin.inputlogic;
...
import lingu.keyboard.latin.LastComposedWord;
import lingu.keyboard.latin.LatinIME;
import lingu.keyboard.latin.NgramContext;
import lingu.keyboard.latin.RichInputConnection;
import lingu.keyboard.latin.Suggest;
import lingu.keyboard.latin.Suggest.OnGetSuggestedWordsCallback;
import lingu.keyboard.latin.SuggestedWords;
import lingu.keyboard.latin.SuggestedWords.SuggestedWordInfo;
import lingu.keyboard.latin.WordComposer;
...
import lingu.keyboard.latin.common.StringUtilsKt;
import lingu.keyboard.latin.common.SuggestionSpanUtilsKt;
...
import lingu.keyboard.latin.utils.AsyncResultHolder;
import lingu.keyboard.latin.utils.InputTypeUtils;
import lingu.keyboard.latin.utils.IntentUtils;
import lingu.keyboard.latin.utils.Log;
import lingu.keyboard.latin.utils.RecapitalizeStatus;
...
import lingu.keyboard.latin.utils.TimestampKt;
...
public final class InputLogic {
     ...
     *     {@link lingu.keyboard.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    private void handleFunctionalEvent(final Event event, final InputTransaction inputTransaction,
        ...
        switch (keyCode) {
            ...
            case KeyCode.TOGGLE_ONE_HANDED_MODE, KeyCode.SWITCH_ONE_HANDED_MODE:
                break;
    ...
    /**
     * Make a {@link lingu.keyboard.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link lingu.keyboard.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, lingu.keyboard.latin.SuggestedWords)}.
