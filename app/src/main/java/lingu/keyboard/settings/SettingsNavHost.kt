...
import lingu.keyboard.latin.settings.getTransitionAnimationScale
import lingu.keyboard.settings.screens.AboutScreen
import lingu.keyboard.settings.screens.AdvancedSettingsScreen
import lingu.keyboard.settings.screens.AppearanceScreen
import lingu.keyboard.settings.screens.ColorsScreen
import lingu.keyboard.settings.screens.DebugScreen
import lingu.keyboard.settings.screens.DictionaryScreen
import lingu.keyboard.settings.screens.GestureTypingScreen
import lingu.keyboard.settings.screens.LanguageScreen
import lingu.keyboard.settings.screens.MainSettingsScreen
import lingu.keyboard.settings.screens.PersonalDictionariesScreen
import lingu.keyboard.settings.screens.PersonalDictionaryScreen
import lingu.keyboard.settings.screens.PreferencesScreen
import lingu.keyboard.settings.screens.SecondaryLayoutScreen
import lingu.keyboard.settings.screens.SubtypeScreen
import lingu.keyboard.settings.screens.TextCorrectionScreen
import lingu.keyboard.settings.screens.ToolbarScreen
