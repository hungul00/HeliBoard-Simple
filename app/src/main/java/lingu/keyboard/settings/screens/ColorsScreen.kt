...
import lingu.keyboard.latin.common.default
...
import lingu.keyboard.settings.CloseIcon
...
import lingu.keyboard.settings.contentTextDirectionStyle
import lingu.keyboard.settings.dialogs.ColorPickerDialog
...
//                supportingText = { if (!nameValid) Text(stringResource(R.string.name_invalid)) } // todo: this is cutting off bottom half of the actual text...
        ...
        menu = listOf(
            ...
            stringResource(R.string.copy_to_clipboard) to {
                ...
                cm.setPrimaryClip(ClipData.newPlainText("LKSBoard theme", getColorString(prefs, newThemeName.text)))
            },
        ),
