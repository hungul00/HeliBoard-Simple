...
import lingu.keyboard.keyboard.KeyboardLayoutSet.KeyboardLayoutSetException;
import lingu.keyboard.keyboard.clipboard.ClipboardHistoryView;
import lingu.keyboard.keyboard.emoji.EmojiPalettesView;
import lingu.keyboard.keyboard.internal.KeyboardState;
import lingu.keyboard.latin.InputView;
import lingu.keyboard.latin.KeyboardWrapperView;
import lingu.keyboard.latin.LatinIME;
import lingu.keyboard.latin.R;
import lingu.keyboard.latin.RichInputMethodManager;
...
import lingu.keyboard.latin.utils.CapsModeUtils;
...
import lingu.keyboard.latin.utils.ResourceUtils;
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void saveKeyboardState() {
        if (getKeyboard() != null || isShowingClipboardHistory()) {
...
//        mEmojiPalettesView.setVisibility(View.VISIBLE);
    ...
    public KeyboardSwitchState getKeyboardSwitchState() {
        boolean hidden =  !isShowingClipboardHistory()
...
//            return KeyboardSwitchState.EMOJI;
    ...
    public void onToggleKeyboard(@NonNull final KeyboardSwitchState toggleState) {
        ...
        if (currentState == toggleState) {
            ...
            if (toggleState == KeyboardSwitchState.CLIPBOARD) {
